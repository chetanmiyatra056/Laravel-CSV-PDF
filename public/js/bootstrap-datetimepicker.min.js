  ...
  var a = function (a, n) {
    var r,
      ...
      E = function () {
            ...
            .append(
              ...
              (p = [
                ...
                e("<div>")
                  ...
                  .append(
                    e("<table>").addClass("table-condensed").append([a, r, i])
                  )),
              ]),
              S("h") && p.push(o),
              S("m") && p.push(d),
        ...
        return (
          ...
          s && f.addClass("usetwentyfour"),
          S("s") && !s && f.addClass("wider"),
          n.sideBySide && P() && O()
            ? (f.addClass("timepicker-sbs"),
              "top" === n.toolbarPlacement && f.append(g),
              f.append(
                e("<div>")
                  .addClass("row")
              ...
              "bottom" === n.toolbarPlacement && f.append(g),
              f)
            : ("top" === n.toolbarPlacement && y.append(g),
              P() &&
                y.append(
                  e("<li>")
                    .addClass(n.collapse && O() ? "collapse show" : "")
                    .append(h)
                ),
              "default" === n.toolbarPlacement && y.append(g),
              O() &&
                y.append(
                  e("<li>")
                    .addClass(n.collapse && P() ? "collapse" : "")
                    .append(m)
                ),
              "bottom" === n.toolbarPlacement && y.append(g),
              f.append(y))
        );
      },
      H = function () {
      ...
      Y = function (e) {
        "y" === e && (e = "YYYY"),
          I({ type: "dp.update", change: e, viewDate: i.clone() });
      },
      q = function (e) {
        y &&
          (e && (p = Math.max(g, Math.min(3, p + e))),
          y
            .find(".datepicker > div")
            .hide()
            .filter(".datepicker-" + w[p].clsName)
            .show());
      },
      B = function (t, a) {
      ...
      j = function () {
        ...
        if (P()) {
          for (
            l.eq(0).find("span").attr("title", n.tooltips.prevMonth),
              l.eq(1).attr("title", n.tooltips.selectMonth),
              l.eq(2).find("span").attr("title", n.tooltips.nextMonth),
              d.find(".disabled").removeClass("disabled"),
              l.eq(1).text(i.format(n.dayViewHeaderFormat)),
              B(i.clone().subtract(1, "M"), "M") ||
                l.eq(0).addClass("disabled"),
              B(i.clone().add(1, "M"), "M") || l.eq(2).addClass("disabled"),
            ...
            0 === a.weekday() &&
              ((o = e("<tr>")),
              n.calendarWeeks &&
                o.append('<td class="cw">' + a.week() + "</td>"),
              p.push(o)),
              (c = ["day"]),
              a.isBefore(i, "M") && c.push("old"),
              a.isAfter(i, "M") && c.push("new"),
              a.isSame(r, "d") && !h && c.push("active"),
              B(a, "d") || c.push("disabled"),
              a.isSame(M(), "d") && c.push("today"),
              (0 !== a.day() && 6 !== a.day()) || c.push("weekend"),
              I({ type: "dp.classify", date: a, classNames: c }),
              o.append(
              ...
              a.add(1, "d");
          var u, f, m;
          d.find("tbody").empty().append(p),
            (u = y.find(".datepicker-months")),
            (f = u.find("th")),
            (m = u.find("tbody").find("span")),
            f.eq(0).find("span").attr("title", n.tooltips.prevYear),
            f.eq(1).attr("title", n.tooltips.selectYear),
            f.eq(2).find("span").attr("title", n.tooltips.nextYear),
            u.find(".disabled").removeClass("disabled"),
            B(i.clone().subtract(1, "y"), "y") || f.eq(0).addClass("disabled"),
            f.eq(1).text(i.year()),
            B(i.clone().add(1, "y"), "y") || f.eq(2).addClass("disabled"),
            m.removeClass("active"),
            r.isSame(i, "y") && !h && m.eq(r.month()).addClass("active"),
            m.each(function (t) {
            ...
            (function () {
              var e,
                ...
                u = "";
              for (
                o.eq(0).find("span").attr("title", n.tooltips.prevCentury),
                ...
                (e = s.year() + 12),
                  (p =
                    n.minDate &&
                    n.minDate.isAfter(s, "y") &&
                    n.minDate.year() <= e),
                  (c =
                    n.maxDate &&
                    n.maxDate.isAfter(s, "y") &&
                    n.maxDate.year() <= e),
                  (u +=
      ...
      A = function () {
        var t,
          a,
          o = y.find(".timepicker span[data-time-component]");
        s ||
          ((t = y.find(".timepicker [data-action=togglePeriod]")),
          (a = r.clone().add(r.hours() >= 12 ? -12 : 12, "h")),
          t.text(r.format("A")),
          B(a, "h") ? t.removeClass("disabled") : t.addClass("disabled")),
          o
            .filter("[data-time-component=hours]")
            .text(r.format(s ? "HH" : "hh")),
          o.filter("[data-time-component=minutes]").text(r.format("mm")),
          o.filter("[data-time-component=seconds]").text(r.format("ss")),
          (function () {
      ...
      L = function (e) {
        ...
        if (!e)
          return (
            ...
            o.val(""),
            a.data("date", ""),
            I({ type: "dp.change", date: !1, oldDate: t }),
            void F()
          );
        if (
        ...
        B(e)
          ? ((i = (r = e).clone()),
            ...
            (h = !1),
            F(),
            I({ type: "dp.change", date: r.clone(), oldDate: t }))
          : (n.keepInvalid
              ? I({ type: "dp.change", date: e, oldDate: t })
              : o.val(h ? "" : r.format(d)),
            I({ type: "dp.error", date: e, oldDate: t }));
      },
      W = function () {
        var t = !1;
        return y
      ...
      N = function (e) {
        return (
          void 0 === n.parseInputDate
            ? (!t.isMoment(e) || e instanceof Date) && (e = M(e))
      ...
      V = {
        ...
        selectMonth: function (t) {
          ...
          i.month(a),
            p === g
              ? (L(r.clone().year(i.year()).month(i.month())), n.inline || W())
              : (q(-1), j()),
            Y("M");
        },
        selectYear: function (t) {
          ...
          i.year(a),
            p === g
              ? (L(r.clone().year(i.year())), n.inline || W())
              : (q(-1), j()),
            Y("YYYY");
        },
        ...
        selectDay: function (t) {
          ...
          e(t.target).is(".old") && a.subtract(1, "M"),
            ...
            L(a.date(parseInt(e(t.target).text(), 10))),
            O() || n.keepOpen || n.inline || W();
        },
        ...
        selectMinute: function (t) {
          L(r.clone().minutes(parseInt(e(t.target).text(), 10))),
            V.showPicker.call(f);
        },
        selectSecond: function (t) {
          L(r.clone().seconds(parseInt(e(t.target).text(), 10))),
            V.showPicker.call(f);
        },
        clear: z,
        today: function () {
      ...
      Z = function (t) {
        return (
          ...
          (V[e(t.currentTarget).data("action")].apply(f, arguments), !1)
        );
      },
      R = function () {
        var t;
        return o.prop("disabled") ||
          ...
          : (void 0 !== o.val() && 0 !== o.val().trim().length
            ...
            (function () {
              for (
                var t = [], a = i.clone().startOf("y").startOf("d");
                a.isSame(i, "y");
    ...
    if (
      ((f.destroy = function () {
        W(),
          ...
          a.is("input")
            ? o.off({ focus: R })
            : m && (m.off("click", Q), m.off("mousedown", !1)),
      ...
      (f.daysOfWeekDisabled = function (e) {
        ...
        if ("boolean" == typeof e && !e)
          return (n.daysOfWeekDisabled = !1), F(), f;
      ...
      (f.maxDate = function (e) {
        ...
        return (
          (n.maxDate = t),
          n.useCurrent && !n.keepInvalid && r.isAfter(e) && L(n.maxDate),
      ...
      (f.minDate = function (e) {
        ...
        return (
          (n.minDate = t),
          n.useCurrent && !n.keepInvalid && r.isBefore(e) && L(n.minDate),
    ...
    return (
      ...
      e.extend(
        ...
        n,
        ((u = {}),
        (c = a.is("input") || n.inline ? a.data() : a.find("input").data())
          .dateOptions &&
          c.dateOptions instanceof Object &&
          (u = e.extend(!0, u, c.dateOptions)),
        e.each(n, function (e) {
      ...
      a.is("input")
        ? o.on({ focus: R })
        : m && (m.on("click", Q), m.on("mousedown", !1)),
      o.prop("disabled") && f.disable(),
      o.is("input") && 0 !== o.val().trim().length
        ? L(N(o.val().trim()))
        : n.defaultDate && void 0 === o.attr("placeholder") && L(n.defaultDate),
      n.inline && R(),
      f
    );
  };
    ...
    (e.fn.datetimepicker = function (t) {
      ...
      if ("string" == typeof t)
        return (
          ...
          i || e.inArray(t, ["destroy", "hide", "show", "toggle"]) > -1
            ? this
            : n
        );
